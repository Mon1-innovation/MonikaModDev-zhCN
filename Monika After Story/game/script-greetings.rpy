...
label monikaroom_greeting_choice:
    ...
    menu:
        "[_opendoor_text]{#monikaroom_greeting_choice_1}" if not persistent.seen_monika_in_room and not mas_isplayer_bday():
        ...
        "Open the door.{#monikaroom_greeting_choice_2}" if persistent.seen_monika_in_room or mas_isplayer_bday():
...
label greeting_found_nou_shirt:
    ...
    menu:
        ...
        "I have no idea...{#greeting_found_nou_shirt_3}":
            hide screen mas_background_timed_jump
            jump greeting_found_nou_shirt.menu_choice_other
