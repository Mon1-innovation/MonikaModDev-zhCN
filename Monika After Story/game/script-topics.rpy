...
label monika_promisering:
    ...
    menu:
        ...
        "Like...marriage?{#monika_promisering}":
...
label monika_sports:
    ...
    menu:
        ...
        "No, but if it were with you...{#monika_sports}":
            $ persistent._mas_pm_like_playing_sports = True
...
label monika_orchestra:
    ...
    menu:
        ...
        "Yes.{#monika_orchestra_2}":
            ...
            elif tempinstrument == "piano" or tempinstrument == "钢琴":
    ...
    if mas_isA01() and mas_isMoniNormal(higher=True):
        ...
        if shown_count == 0:
            ...
            if mas_isMoniUpset(lower=True):
                ...
                if persistent.monika_kill:
                    $ menuOption = _("You've done it before, but you wouldn't do that anymore, right?")
                else:
                    $ menuOption = _("You'd never do that, right?")
...
label monika_smoking:
    ...
    $ menu_question = _("Do you still smoke") if persistent._mas_pm_do_smoke else "You don't smoke, do you"
...
label monika_player_appearance_eye_color_ask(x_side_eye="left", last_color=None):
    ...
    menu:
        ...
        "Blue" if last_color != "blue{#monika_player_appearance_eye_color_heterochromia_1}":
            $ eye_color = "blue"

        "Brown" if last_color != "brown{#monika_player_appearance_eye_color_heterochromia_2}":
            $ eye_color = "brown"

        "Green" if last_color != "green{#monika_player_appearance_eye_color_heterochromia_3}":
            $ eye_color = "green"

        "Hazel" if last_color != "hazel{#monika_player_appearance_eye_color_heterochromia_4}":
            $ eye_color = "hazel"

        "Gray" if last_color != "gray{#monika_player_appearance_eye_color_heterochromia_5}":
            $ eye_color = "gray"

        "Black" if last_color != "black{#monika_player_appearance_eye_color_heterochromia_6}":
            $ eye_color = "black"
